...
char greeting[6] = {'H', 'e', 'l', 'l', 'o', '\0'};: Declares an array greeting of characters with a size of 6. The characters 'H', 'e', 'l', 'l', 'o' form the string "Hello", and '\0' is the null terminator explicitly added at the end.
